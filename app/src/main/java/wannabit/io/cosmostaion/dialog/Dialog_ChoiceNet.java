...
public class Dialog_ChoiceNet extends DialogFragment {
    ...
    private LinearLayout mBand, mPersis, mCertik, mAkash, mSentinel, mFetch, mCryto, mSifchain, mKichain, mOsmosis, mMedi, mEmoney, mRegen, mRizon, mJuno, mSecret, mCosmosTest, mIrisTest;
