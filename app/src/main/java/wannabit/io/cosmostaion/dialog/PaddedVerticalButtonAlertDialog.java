...
public class PaddedVerticalButtonAlertDialog extends AlertDialog {
    ...
    public static void showDoubleButton(Context context, CharSequence title, CharSequence message, CharSequence Button1Title, View.OnClickListener Button1Listener, CharSequence Button2Title, View.OnClickListener Button2Listener, Boolean cancelable) {
        PaddedVerticalButtonAlertDialog dialog = makeDoubleButton(context, title, message, Button1Title, Button1Listener, Button2Title, Button2Listener);
    ...
    public static void showTripleButton(Context context, CharSequence title, CharSequence message, CharSequence Button1Title, View.OnClickListener Button1Listener,
        ...
        PaddedVerticalButtonAlertDialog dialog = makeTripleButton(context, title, message, Button1Title, Button1Listener, Button2Title, Button2Listener, Button3Title, Button3Listener);
        dialog.setCancelable(cancelable);
        dialog.create();
        dialog.show();
    }
    ...
    private static PaddedVerticalButtonAlertDialog makeDoubleButton(Context context, CharSequence title, CharSequence message, CharSequence Button1Title, View.OnClickListener Button1Listener, CharSequence Button2Title, View.OnClickListener Button2Listener) {
    ...
    private static PaddedVerticalButtonAlertDialog makeTripleButton(Context context, CharSequence title, CharSequence message, CharSequence Button1Title, View.OnClickListener Button1Listener,
                                                                    CharSequence Button2Title, View.OnClickListener Button2Listener, CharSequence Button3Title, View.OnClickListener Button3Listener) {
        PaddedVerticalButtonAlertDialog dialog = makeDoubleButton(context, title, message, Button1Title, Button1Listener, Button2Title, Button2Listener);
