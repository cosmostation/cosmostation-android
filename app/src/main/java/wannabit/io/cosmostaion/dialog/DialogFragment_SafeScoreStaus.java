...
public class DialogFragment_SafeScoreStaus extends DialogFragment {

    public static DialogFragment_SafeScoreStaus newInstance(Bundle bundle) {
        DialogFragment_SafeScoreStaus frag = new DialogFragment_SafeScoreStaus();
