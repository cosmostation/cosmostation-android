...
public class Dialog_Osmo_Unlock_All extends BottomSheetDialogFragment {

    public static Dialog_Osmo_Unlock_All getInstance(Bundle bundle) {
        Dialog_Osmo_Unlock_All frag = new Dialog_Osmo_Unlock_All();
