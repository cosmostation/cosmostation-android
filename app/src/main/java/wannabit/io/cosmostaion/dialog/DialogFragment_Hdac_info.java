...
public class DialogFragment_Hdac_info extends DialogFragment {

    public static DialogFragment_Hdac_info newInstance(Bundle bundle) {
        DialogFragment_Hdac_info frag = new DialogFragment_Hdac_info();
