...
public class DialogFragment_SafeScoreCreate extends DialogFragment {

    public static DialogFragment_SafeScoreCreate newInstance(Bundle bundle) {
        DialogFragment_SafeScoreCreate frag = new DialogFragment_SafeScoreCreate();
