...
public class DialogFragment_Wc_Account extends DialogFragment {
    ...
    public static DialogFragment_Wc_Account newInstance(Bundle bundle) {
        DialogFragment_Wc_Account frag = new DialogFragment_Wc_Account();
