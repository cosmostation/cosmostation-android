...
public class SimulAuthzVoteGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcAuthzVoteSimulateReq(mAuthResponse, mAccount.address, mGranter, mOpinionMap, mFee, mMemo, ecKey, mChainId);
