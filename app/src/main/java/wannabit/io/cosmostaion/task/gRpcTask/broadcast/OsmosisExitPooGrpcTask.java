...
public class OsmosisExitPooGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcExitPoolReq(mAuthResponse, mPoolId, mDeposit0Coin, mDeposit1Coin, mShareAmount, mFees, mMemo, ecKey, mChainId);
