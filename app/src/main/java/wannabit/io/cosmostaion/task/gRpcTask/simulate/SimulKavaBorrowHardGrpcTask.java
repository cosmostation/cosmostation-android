...
public class SimulKavaBorrowHardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaBorrowHardSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mBorrower, mBorrowCoins, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
