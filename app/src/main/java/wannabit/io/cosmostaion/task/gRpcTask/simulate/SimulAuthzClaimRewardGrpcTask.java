...
public class SimulAuthzClaimRewardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcAuthzClaimRewardSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mAccount.address, mGranter, mValAddressList, mFee, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
