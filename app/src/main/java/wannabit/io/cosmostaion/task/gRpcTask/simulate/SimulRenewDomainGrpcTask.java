...
public class SimulRenewDomainGrpcTask extends CommonTask {
    ...
    public SimulRenewDomainGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain, String memo, Fee fee, String chainId) {
        ...
        this.result.taskType = TASK_GRPC_SIMULATE_RENEW_DOMAIN;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcRenewDomainSimulateReq(mAuthResponse, mDomain, mAccount.address, mFees, mMemo, ecKey, mChainId);
