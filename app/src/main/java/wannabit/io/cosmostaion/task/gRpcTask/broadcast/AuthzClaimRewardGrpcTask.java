...
public class AuthzClaimRewardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcAuthzClaimRewardReq(mAuthResponse, mAccount.address, mGranter, mValAddressList, mFee, mMemo, ecKey, mChainId);
