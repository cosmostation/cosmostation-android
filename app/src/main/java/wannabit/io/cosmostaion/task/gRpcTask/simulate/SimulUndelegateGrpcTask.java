...
public class SimulUndelegateGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcUnDelegateSimulateReq(mAuthResponse, mValidatorAddress, mAmount, mFees, mMemo, ecKey, mChainId);
