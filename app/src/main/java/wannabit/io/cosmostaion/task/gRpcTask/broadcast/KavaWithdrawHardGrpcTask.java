...
public class KavaWithdrawHardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaWithdrawHardReq(WKey.onAuthResponse(mBaseChain, mAccount), mDepositor, mWithdrawCoins, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
