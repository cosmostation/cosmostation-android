...
public class KavaWithdrawHardGrpcTask extends CommonTask {
    ...
    public KavaWithdrawHardGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String depositor,
        ...
        this.result.taskType = TASK_GRPC_GEN_TX_KAVA_WITHDRAW_HARD;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaWithdrawHardReq(mAuthResponse, mDepositor, mWithdrawCoins, mFees, mMemo, ecKey, mChainId);
