...
public class SimulSifWithdrawGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcSifWithdrawSimulateReq(mAuthResponse, mSigner, mExternalDemon, mWBasisPoints, mFees, mMemo, deterministicKey, mChainId);
