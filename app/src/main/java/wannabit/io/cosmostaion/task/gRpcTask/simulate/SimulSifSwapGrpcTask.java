...
public class SimulSifSwapGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcSifSwapSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mSinger, mSwapInCoin, mSwapOutCoin, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
