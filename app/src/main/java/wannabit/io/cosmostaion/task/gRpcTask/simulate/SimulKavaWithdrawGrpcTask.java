...
public class SimulKavaWithdrawGrpcTask extends CommonTask {
    ...
    public SimulKavaWithdrawGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String from, String shares,
        ...
        this.result.taskType = TASK_GRPC_SIMULATE_KAVA_WITHDRAW;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaWithdrawPoolSimulateReq(mAuthResponse, mFrom, mShares, mMinTokenA, mMinTokenB, mDeadline, mFees, mMemo, ecKey, mChainId);
