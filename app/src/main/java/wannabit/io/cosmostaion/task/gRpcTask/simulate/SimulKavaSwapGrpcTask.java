...
public class SimulKavaSwapGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaSwapSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mRequester, mSwapIn, mSwapOut, mSlippage, mDeadline, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
