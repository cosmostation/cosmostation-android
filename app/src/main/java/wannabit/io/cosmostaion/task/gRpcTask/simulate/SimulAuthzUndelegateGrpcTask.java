...
public class SimulAuthzUndelegateGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcAuthzUndelegateSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mAccount.address, mGranter, mValAddress, mAmount, mFee, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
