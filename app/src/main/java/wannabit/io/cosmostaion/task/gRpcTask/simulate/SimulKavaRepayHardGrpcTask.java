...
public class SimulKavaRepayHardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaRepayHardSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mSender, mOwner, mRepayCoins, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
