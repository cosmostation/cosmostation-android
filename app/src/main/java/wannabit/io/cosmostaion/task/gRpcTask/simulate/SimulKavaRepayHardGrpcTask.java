...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_SIMULATE_KAVA_REPAY_HARD;
...
public class SimulKavaRepayHardGrpcTask extends CommonTask {
    ...
    public SimulKavaRepayHardGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender, String owner,
        ...
        this.mResult.taskType = TASK_GRPC_SIMULATE_KAVA_REPAY_HARD;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaRepayHardSimulateReq(mAuthResponse, mSender, mOwner, mRepayCoins, mFees, mMemo, ecKey, mChainId);
