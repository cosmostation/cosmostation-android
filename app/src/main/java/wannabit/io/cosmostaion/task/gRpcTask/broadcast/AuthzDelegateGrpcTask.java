...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_AUTHZ_DELEGATE;
...
public class AuthzDelegateGrpcTask extends CommonTask {
    ...
    public AuthzDelegateGrpcTask(BaseApplication app, TaskListener listener, BaseChain basechain, Account account, String granter, String toValAddress, Coin amount, String memo, Fee fee, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_AUTHZ_DELEGATE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcAuthzDelegateReq(mAuthResponse, mAccount.address, mGranter, mValAddress, mAmount, mFee, mMemo, ecKey, mChainId);
