...
public class KavaRepayCdpGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaRepayCdpReq(WKey.onAuthResponse(mBaseChain, mAccount), mSender, mPayment, mCollateralType, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
