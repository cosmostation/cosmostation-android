...
public class KavaRepayCdpGrpcTask extends CommonTask {
    ...
    public KavaRepayCdpGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender,
        ...
        this.result.taskType = TASK_GRPC_GEN_TX_KAVA_REPAY_CDP;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaRepayCdpReq(mAuthResponse, mSender, mPayment, mCollateralType, mFees, mMemo, ecKey, mChainId);
