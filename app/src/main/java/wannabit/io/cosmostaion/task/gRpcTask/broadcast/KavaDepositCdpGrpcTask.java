...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_DEPOSIT_CDP;
...
public class KavaDepositCdpGrpcTask extends CommonTask {
    ...
    public KavaDepositCdpGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String owner, String depositor,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_KAVA_DEPOSIT_CDP;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaDepositCdpReq(mAuthResponse, mOwner, mDepositor, mCollateral, mCollateralType, mFees, mMemo, ecKey, mChainId);
