...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_CREATE_CDP;
...
public class KavaCreateCdpGrpcTask extends CommonTask {
    ...
    public KavaCreateCdpGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender,
        ...
        this.result.taskType = TASK_GRPC_GEN_TX_KAVA_CREATE_CDP;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaCreateCdpReq(mAuthResponse, mSender, mCollateral, mPrincipal, mCollateralType, mFees, mMemo, ecKey, mChainId);
