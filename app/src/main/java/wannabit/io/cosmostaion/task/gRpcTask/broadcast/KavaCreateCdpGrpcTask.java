...
public class KavaCreateCdpGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaCreateCdpReq(WKey.onAuthResponse(mBaseChain, mAccount), mSender, mCollateral, mPrincipal, mCollateralType, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
