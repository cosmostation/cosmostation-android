...
public class KavaWithdrawCdpGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaWithdrawCdpReq(WKey.onAuthResponse(mBaseChain, mAccount), mOwner, mDepositor, mCollateral, mCollateralType, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
