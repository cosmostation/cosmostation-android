...
public class SimulKavaCreateCdpGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaCreateCdpSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mSender, mCollateral, mPrincipal, mCollateralType, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
