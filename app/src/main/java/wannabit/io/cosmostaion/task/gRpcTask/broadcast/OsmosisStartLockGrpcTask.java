...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_START_LOCK;
...
public class OsmosisStartLockGrpcTask extends CommonTask {
    ...
    public OsmosisStartLockGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, long mDuration, Coin mLpCoin, String memo, Fee fee, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_START_LOCK;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcStartLockReq(mAuthResponse, mDuration, mLpCoin, mFees, mMemo, ecKey, mChainId);
