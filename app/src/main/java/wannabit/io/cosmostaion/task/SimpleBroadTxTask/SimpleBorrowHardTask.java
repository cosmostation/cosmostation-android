...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GEN_TX_KAVA_BORROW_HARD;

public class SimpleBorrowHardTask extends CommonTask {
    ...
    public SimpleBorrowHardTask(BaseApplication app, TaskListener listener, Account account, ArrayList<Coin> coins, String depositor, String memo, Fee fees) {
        super(app, listener);
        ...
        this.mMemo = memo;
        this.mFees = fees;
        this.mResult.taskType = TASK_GEN_TX_KAVA_BORROW_HARD;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            Msg borrowHardMsg = MsgGenerator.genBorrowHardMsg(mDepositor, mCoin, BaseChain.getChain(mAccount.baseChain));
            ArrayList<Msg> msgs= new ArrayList<>();
            msgs.add(borrowHardMsg);
//            WLog.w("borrowHardMsg : " +  WUtil.prettyPrinter(borrowHardMsg));
