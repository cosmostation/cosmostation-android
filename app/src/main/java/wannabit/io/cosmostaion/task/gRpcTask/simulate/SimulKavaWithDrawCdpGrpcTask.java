...
public class SimulKavaWithDrawCdpGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaWithdrawCdpSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mOwner, mDepositor, mCollateral, mCollateralType, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
