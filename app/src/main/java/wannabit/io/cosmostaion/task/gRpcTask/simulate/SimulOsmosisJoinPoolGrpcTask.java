...
public class SimulOsmosisJoinPoolGrpcTask extends CommonTask {
    ...
    public SimulOsmosisJoinPoolGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, long poolId, Coin deposit0Coin, Coin deposit1Coin, String shareAmount, String memo, Fee fee, String chainId) {
        super(app, listener);
        ...
        this.result.taskType = TASK_GRPC_SIMULATE_JOIN_POOL;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcJoinPoolSimulateReq(mAuthResponse, mPoolId, mDeposit0Coin, mDeposit1Coin, mShareAmount, mFees, mMemo, ecKey, mChainId);
