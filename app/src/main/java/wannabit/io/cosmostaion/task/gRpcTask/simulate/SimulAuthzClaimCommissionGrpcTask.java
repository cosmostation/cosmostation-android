...
public class SimulAuthzClaimCommissionGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcAuthzClaimCommissionSimulateReq(mAuthResponse, mAccount.address, mValAddress, mFee, mMemo, ecKey, mChainId);
