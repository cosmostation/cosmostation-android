...
public class SimulChangeRewardAddressGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcRewardAddressChangeSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mToRewardAddress, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
