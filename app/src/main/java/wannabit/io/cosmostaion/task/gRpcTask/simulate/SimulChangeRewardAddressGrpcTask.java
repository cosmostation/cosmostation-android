...
public class SimulChangeRewardAddressGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcRewardAddressChangeSimulateReq(mAuthResponse, mToRewardAddress, mFees, mMemo, deterministicKey, mChainId);
