...
public class SimulCw20IbcSendGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcCw20IbcTransferSimulateReq(mAuthResponse, mSender, mRemoteAddress, mContractAddress, mAssetPath, mAmount, mFees, mMemo, ecKey, mChainId);
