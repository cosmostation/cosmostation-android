...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_WITHDRAW;
...
public class KavaWithdrawGrpcTask extends CommonTask {
    ...
    public KavaWithdrawGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String from, String shares,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_KAVA_WITHDRAW;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaWithdrawReq(mAuthResponse, mFrom, mShares, mMinTokenA, mMinTokenB, mDeadline, mFees, mMemo, ecKey, mChainId);
