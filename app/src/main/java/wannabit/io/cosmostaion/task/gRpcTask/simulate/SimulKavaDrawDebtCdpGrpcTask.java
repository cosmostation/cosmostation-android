...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_SIMULATE_KAVA_DRAW_DEBT_CDP;
...
public class SimulKavaDrawDebtCdpGrpcTask extends CommonTask {
    ...
    public SimulKavaDrawDebtCdpGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender,
        ...
        this.result.taskType = TASK_GRPC_SIMULATE_KAVA_DRAW_DEBT_CDP;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaDrawDebtCdpSimulateReq(mAuthResponse, mSender, mPrincipal, mCollateralType, mFees, mMemo, ecKey, mChainId);
