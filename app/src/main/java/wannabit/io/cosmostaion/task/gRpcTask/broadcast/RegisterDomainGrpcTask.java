...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_REGISTER_DOMAIN;
...
public class RegisterDomainGrpcTask extends CommonTask {
    ...
    public RegisterDomainGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain, String domainType, String memo, Fee fees, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_REGISTER_DOMAIN;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcRegisterDomainReq(mAuthResponse, mDomain, mAccount.address, mDomainType, mFees, mMemo, deterministicKey, mChainId);
