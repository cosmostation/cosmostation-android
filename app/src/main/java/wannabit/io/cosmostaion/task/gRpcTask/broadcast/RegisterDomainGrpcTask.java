...
public class RegisterDomainGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcRegisterDomainReq(mAuthResponse, mDomain, mAccount.address, mDomainType, mFees, mMemo, ecKey, mChainId);
