...
public class KavaDepositHardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaDepositHardReq(WKey.onAuthResponse(mBaseChain, mAccount), mDepositor, mDepositCoins, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
