...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_BORROW_HARD;
...
public class KavaBorrowHardGrpcTask extends CommonTask {

    private final Account mAccount;
    private final BaseChain mBaseChain;
    private final String mBorrower;
    private final ArrayList<Coin> mBorrowCoins;
    ...
    public KavaBorrowHardGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String borrower,
        ...
        this.result.taskType = TASK_GRPC_GEN_TX_KAVA_BORROW_HARD;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaBorrowHardReq(mAuthResponse, mBorrower, mBorrowCoins, mFees, mMemo, ecKey, mChainId);
            ...
            WLog.e("KavaBorrowHardGrpcTask " + e.getMessage());
            result.isSuccess = false;
        }
        return result;
    }
