...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_SIMULATE_KAVA_CLAIM_INCENTIVES;
...
public class SimulKavaClaimIncentiveAllGrpcTask extends CommonTask {
    ...
    public SimulKavaClaimIncentiveAllGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender,
        ...
        this.mResult.taskType = TASK_GRPC_SIMULATE_KAVA_CLAIM_INCENTIVES;
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaIncentiveAllSimulateReq(mAuthResponse, mSender, mMultiplierName, mBaseData, mFees, mMemo, ecKey, mChainId);
