...
public class SimulKavaWithdrawHardGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcKavaWithdrawHardSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mDepositor, mWithdrawCoins, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
