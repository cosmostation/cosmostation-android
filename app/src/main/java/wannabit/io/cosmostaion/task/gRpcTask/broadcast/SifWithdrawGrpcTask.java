...
public class SifWithdrawGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcSifWithdrawReq(WKey.onAuthResponse(mBaseChain, mAccount), mSigner, mExternalDemon, mWBasisPoints, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
