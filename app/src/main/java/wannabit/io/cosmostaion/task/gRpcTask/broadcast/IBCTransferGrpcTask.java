...
public class IBCTransferGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcIbcTransferReq(mAuthResponse, mSender, mReceiver, mTokenDenom, mTokenAmount, mAsset, value.getLatestHeight(), mFees, "", ecKey, mChainId);
