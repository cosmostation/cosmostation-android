...
public class LinkAccountGrpcTask extends CommonTask {
    ...
    public LinkAccountGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String signer, BaseChain toChain, Account toAccount,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_LINK_ACCOUNT;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcLinkAccountReq(mAuthResponse, mSigner, mToChain, mToAccount, mToEcKey, mFees, mMemo, ecKey, mChainId);
