...
public class SifDepositGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcSifDepositReq(mAuthResponse, mSigner, mExternalDemon, mNativeAmount, mExternalAmount, mFees, mMemo, ecKey, mChainId);
