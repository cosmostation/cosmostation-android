...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_SIF_JOIN_POOL;
...
public class SifDepositGrpcTask extends CommonTask {
    ...
    public SifDepositGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String signer, String externalDemon, String nativeAmount, String externalAmount, String memo, Fee fee, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_SIF_JOIN_POOL;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcSifDepositReq(mAuthResponse, mSigner, mExternalDemon, mNativeAmount, mExternalAmount, mFees, mMemo, deterministicKey, mChainId);
