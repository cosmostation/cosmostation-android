...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_REPAY_HARD;
...
public class KavaRepayHardGrpcTask extends CommonTask {
    ...
    public KavaRepayHardGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String sender, String owner,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_KAVA_REPAY_HARD;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaRepayHardReq(mAuthResponse, mSender, mOwner, mRepayCoins, mFees, mMemo, ecKey, mChainId);
