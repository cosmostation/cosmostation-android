...
public class SifIncentiveGrpcTask extends CommonTask {
    ...
    public SifIncentiveGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String userAddress, String memo, Fee fee, String chainId) {
        super(app, listener);
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_SIF_CLAIM_INCENTIVE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcSifIncentiveReq(mAuthResponse, mUserAddress, mFees, mMemo, deterministicKey, mChainId);
