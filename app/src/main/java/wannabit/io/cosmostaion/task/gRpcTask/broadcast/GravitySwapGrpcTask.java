...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_GRAVITY_SWAP;

public class GravitySwapGrpcTask extends CommonTask {
    ...
    public GravitySwapGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, long poolId, Coin offerCoin,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_GRAVITY_SWAP;
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcGravitySwapReq(mAuthResponse, mPoolId, mTypeId, mOfferCoin, mDemandCoinDenom, mCoinFee, mOrderPrice, mFees, mMemo, ecKey, mChainId);
            ...
            WLog.e( "GravitySwapGrpcTask "+ e.getMessage());
            mResult.isSuccess = false;
        }
        return mResult;
    }
