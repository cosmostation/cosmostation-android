...
public class SimulOsmosisExitPoolGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcExitPoolSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mPoolId, mWithdraw0Coin, mWithdraw1Coin, mShareAmount, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
