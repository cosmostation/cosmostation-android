...
public class KavaDepositGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaDepositReq(WKey.onAuthResponse(mBaseChain, mAccount), mDepositor, mTokenA, mTokenB, mSlippage, mDeadline, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId, mAccount.customPath, mBaseChain);
