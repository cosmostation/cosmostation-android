...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GRPC_GEN_TX_KAVA_DEPOSIT;
...
public class KavaDepositGrpcTask extends CommonTask {
    ...
    public KavaDepositGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String depositor,
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_KAVA_DEPOSIT;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaDepositReq(mAuthResponse, mDepositor, mTokenA, mTokenB, mSlippage, mDeadline, mFees, mMemo, ecKey, mChainId);
