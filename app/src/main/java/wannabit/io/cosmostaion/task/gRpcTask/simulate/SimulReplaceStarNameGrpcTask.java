...
public class SimulReplaceStarNameGrpcTask extends CommonTask {
    ...
    public SimulReplaceStarNameGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain,
        ...
        this.result.taskType = TASK_GRPC_SIMULATE_REPLACE_STARNAME;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcReplaceResourceSimulateReq(mAuthResponse, mDomain, mName, mAccount.address, mResources, mFees, mMemo, ecKey, mChainId);
