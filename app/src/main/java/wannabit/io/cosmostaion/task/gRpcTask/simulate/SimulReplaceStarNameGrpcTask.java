...
public class SimulReplaceStarNameGrpcTask  extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcReplaceResourceSimulateReq(WKey.onAuthResponse(mBaseChain, mAccount), mDomain, mName, mAccount.address, mResources, mFees, mMemo, WKey.getECKey(mApp, mAccount), mChainId);
