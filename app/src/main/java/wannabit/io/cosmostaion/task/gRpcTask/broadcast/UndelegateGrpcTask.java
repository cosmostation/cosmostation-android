...
public class UndelegateGrpcTask extends CommonTask {
    ...
    public UndelegateGrpcTask(BaseApplication app, TaskListener listener, BaseChain basechain, Account account, String toValidatorAddress, Coin toDelegateAmount, String toDelegateMemo, Fee toFees, String chainId) {
        ...
        this.result.taskType = TASK_GRPC_BROAD_UNDELEGATE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcUnDelegateReq(mAuthResponse, mValidatorAddress, mAmount, mFees, mMemo, ecKey, mChainId);
