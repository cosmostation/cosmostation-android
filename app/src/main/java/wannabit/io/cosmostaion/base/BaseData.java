...
public class BaseData {
    ...
    public MintscanToken getCw20Asset(ChainConfig chainConfig, String denom) {
        if (chainConfig.baseChain().equals(JUNO_MAIN) || chainConfig.baseChain().equals(NEUTRON_MAIN) || chainConfig.baseChain().equals(TERRA_MAIN) ||
    ...
    public void setMyTokens(ChainConfig chainConfig, String address) {
        ...
        if (chainConfig.baseChain().equals(JUNO_MAIN) || chainConfig.baseChain().equals(NEUTRON_MAIN) || chainConfig.baseChain().equals(TERRA_MAIN) || chainConfig.baseChain().equals(NEUTRON_TEST)) {
