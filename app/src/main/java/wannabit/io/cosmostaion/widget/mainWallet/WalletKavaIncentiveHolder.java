...
public class WalletKavaIncentiveHolder extends BaseHolder {
    ...
    public void onBindHolder(@NotNull MainActivity mainActivity) {
        ...
        mKavaIncetive.setText(WDp.getDpAmount(baseData, mKavaIncetiveAmount, 6, 6));
        mHardIncetive.setText(WDp.getDpAmount(baseData, mHardIncetiveAmount, 6, 6));
        mSwpIncetive.setText(WDp.getDpAmount(baseData, mSwpIncetiveAmount, 6, 6));
