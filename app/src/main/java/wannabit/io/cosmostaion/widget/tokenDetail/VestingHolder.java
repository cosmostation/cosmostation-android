...
public class VestingHolder extends BaseHolder {
    ...
    private void onBindGRPC(Context c, BaseChain chain, BaseData baseData, String denom) {
        ...
        mVestingAmount0.setText(WDp.getDpAmount(baseData, WDp.getAmountVp(vps.get(0), denom), decimal, decimal));
        if (vps.size() > 1) {
            ...
            mVestingAmount1.setText(WDp.getDpAmount(baseData, WDp.getAmountVp(vps.get(1), denom), decimal, decimal));
        }
        if (vps.size() > 2) {
            ...
            mVestingAmount2.setText(WDp.getDpAmount(baseData, WDp.getAmountVp(vps.get(2), denom), decimal, decimal));
        }
        if (vps.size() > 3) {
            ...
            mVestingAmount3.setText(WDp.getDpAmount(baseData, WDp.getAmountVp(vps.get(3), denom), decimal, decimal));
        }
        if (vps.size() > 4) {
            ...
            mVestingAmount4.setText(WDp.getDpAmount(baseData, WDp.getAmountVp(vps.get(4), denom), decimal, decimal));
        }
    }
}
