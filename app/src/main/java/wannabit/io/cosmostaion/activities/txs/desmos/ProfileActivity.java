...
public class ProfileActivity extends BaseBroadCastActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(getString(R.string.str_create_profile_title));

        mTxType = CONST_PW_TX_PROFILE;

        setSupportActionBar(mToolbar);
        getSupportActionBar().setDisplayShowTitleEnabled(false);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        mIvStep.setImageDrawable(ContextCompat.getDrawable(ProfileActivity.this, R.drawable.step_4_img_1));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(ProfileActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_create_profile_step_1));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(ProfileActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_create_profile_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(ProfileActivity.this, R.drawable.step_4_img_4));
                    mTvStep.setText(getString(R.string.str_create_profile_step_3));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                }
            }
    ...
    public void onSaveProfile() {
        if (getBaseDao().isAutoPass()) {
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcCreateProfileReq(getAuthResponse(mBaseChain, mAccount), mDtag, mNickname, mBio,
                    mProfileImg, mCoverImg, mAccount.address, mTxFee, mTxMemo, getEcKey(mAccount), getBaseDao().getChainIdGrpc());
