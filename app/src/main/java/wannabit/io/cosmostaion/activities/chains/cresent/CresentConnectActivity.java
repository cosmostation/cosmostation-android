package wannabit.io.cosmostaion.activities.chains.cresent;
...
public class CresentConnectActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cresent_wallet_connect);
        initView();
        loadInfo();
        initWalletConnect();
    }
    ...
    private void initWalletConnect() {
        ...
        wcClient.setOnKeplrGetKey((id, strings) -> {
            ...
            KeplrWallet keplr = new KeplrWallet(WUtil.getWalletName(this, mAccount),
                    "secp256k1",
        ...
        wcClient.setOnKeplrSignAmino((id, jsonArray) -> {
            String chainId = jsonArray.get(0).getAsString();
            String address = jsonArray.get(1).getAsString();
            ...
            ReqBroadCast tx = MsgGenerator.getKavaBroadcaseReq(account, signMsg.msgs, signMsg.fee, signMsg.memo, mEcKey, signMsg.chain_id);
            Signature signature = tx.tx.signatures.get(0);
            Model3 model3 = new Model3(signMsg, signature);
    ...
    class Model3 {
        ...
        public Model3(StdSignMsg signed, Signature signature) {
            this.signed = signed;
