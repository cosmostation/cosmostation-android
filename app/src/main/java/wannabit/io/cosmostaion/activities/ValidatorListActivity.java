...
public class ValidatorListActivity extends BaseActivity implements FetchCallBack {
    ...
    private void onPasswordCheck() {
        if (getBaseDao().isAutoPass()) {
            ...
            validatorListActivityResultLauncher.launch(intent);
    ...
    private final ActivityResultLauncher<Intent> validatorListActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
