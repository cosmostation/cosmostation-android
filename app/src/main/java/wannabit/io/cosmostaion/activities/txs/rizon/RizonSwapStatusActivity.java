package wannabit.io.cosmostaion.activities.txs.rizon;
...
public class RizonSwapStatusActivity extends BaseBroadCastActivity implements View.OnClickListener, TaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSwipeRefreshLayout.setColorSchemeColors(ContextCompat.getColor(RizonSwapStatusActivity.this, R.color.colorPrimary));
