...
public class AccountDetailActivity extends BaseActivity implements View.OnClickListener, TaskListener {
        ...
        if (v.equals(mBtnCheck)) {
            if (mAccount.hasPrivateKey) {
                ...
                if (getBaseDao().isAutoPass()) {
                    ...
                    accountDetailActivityResultLauncher.launch(checkintent);
                    overridePendingTransition(R.anim.slide_in_bottom, R.anim.fade_out);
                }
    ...
    private final ActivityResultLauncher<Intent> accountDetailActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
