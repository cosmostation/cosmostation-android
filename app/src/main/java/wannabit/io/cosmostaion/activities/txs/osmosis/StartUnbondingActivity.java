        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(StartUnbondingActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_osmosis_start_unbonding_step_1));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(StartUnbondingActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_osmosis_start_unbonding_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(StartUnbondingActivity.this, R.drawable.step_4_img_4));
