...
public class MnemonicListActivity extends BaseActivity implements View.OnClickListener {
        ...
        public void onBindViewHolder(@NonNull ListHolder holder, int position) {
            ...
            holder.itemRoot.setOnClickListener(view -> {
                if (getBaseDao().isAutoPass()) {
                    ...
                    checkIntent.putExtra("mnemonicId", mWord.id);
                    mnemonicListActivityResultLauncher.launch(checkIntent);
    ...
    private final ActivityResultLauncher<Intent> mnemonicListActivityResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
