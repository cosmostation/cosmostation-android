...
public class UndelegateActivity extends BaseBroadCastActivity {
    ...
    private void onUndelegateByLedger() {
        new Thread(() -> {
            ...
            runOnUiThread(() -> LedgerManager.getInstance().pickLedgerDevice(this, new LedgerManager.ConnectListener() {
                ...
                public void error(@NonNull LedgerManager.ErrorType errorType) {
                    ...
                    runOnUiThread(() -> CommonAlertDialog.showDoubleButton(UndelegateActivity.this, getString(R.string.str_ledger_error), getString(errorType.getDescriptionResourceId()), getString(R.string.str_cancel), null, getString(R.string.str_retry), view -> onStartUndelegate()));
                }
                ...
                public void connected() {
                    ...
                    handler.postDelayed(() -> {
                        mDialog = CommonAlertDialog.makeSecondImageSingleButton(UndelegateActivity.this, getString(R.string.str_ledger_approve_title), getString(R.string.str_ledger_approve_msg), getString(R.string.str_cancel), view -> finish(), R.drawable.icon_ledger);
                            ...
                            BleCosmosHelper.Companion.sign(LedgerManager.Companion.getInstance().getBleManager(), mAccount.path, message, new BleCosmosHelper.SignListener() {
                                ...
                                public void success(@NonNull byte[] bytes) {
                                    ...
                                    new Thread(() -> {
                                        ...
                                        onCommonIntentTx(UndelegateActivity.this, mResult);
                                    }).start();
                                }
    ...
    private void onBroadCastTx() {
        new UndelegateGrpcTask(getBaseApplication(), result -> {
            onCommonIntentTx(UndelegateActivity.this, result);
