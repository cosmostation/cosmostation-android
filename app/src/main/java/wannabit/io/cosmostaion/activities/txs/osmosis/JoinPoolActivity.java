...
import wannabit.io.cosmostaion.fragment.txs.osmosis.JoinPoolStep3Fragment;
...
public class JoinPoolActivity extends BaseBroadCastActivity {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(JoinPoolActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_tx_step_memo));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(JoinPoolActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_tx_step_fee));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(JoinPoolActivity.this, R.drawable.step_4_img_4));
    ...
    private void onBroadCastTx() {
        new OsmosisJoinPoolGrpcTask(getBaseApplication(), result -> {
