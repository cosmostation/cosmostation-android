...
import wannabit.io.cosmostaion.fragment.txs.cosmos.GDexDepositStep0Fragment;
import wannabit.io.cosmostaion.fragment.txs.cosmos.GDexDepositStep3Fragment;
...
public class GravityDepositPoolActivity extends BaseBroadCastActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvStep.setImageDrawable(ContextCompat.getDrawable(GravityDepositPoolActivity.this, R.drawable.step_4_img_1));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(GravityDepositPoolActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_join_pool_step_1));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(GravityDepositPoolActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_join_pool_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(GravityDepositPoolActivity.this, R.drawable.step_4_img_4));
