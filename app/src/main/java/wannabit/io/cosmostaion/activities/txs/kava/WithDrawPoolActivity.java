...
import wannabit.io.cosmostaion.fragment.txs.kava.WithdrawPoolStep3Fragment;
...
public class WithDrawPoolActivity extends BaseBroadCastActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvStep.setImageDrawable(ContextCompat.getDrawable(WithDrawPoolActivity.this, R.drawable.step_4_img_1));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(WithDrawPoolActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_exit_pool_step_1));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(WithDrawPoolActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_exit_pool_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(WithDrawPoolActivity.this, R.drawable.step_4_img_4));
    ...
    private void onBroadCastTx() {
        new KavaWithdrawGrpcTask(getBaseApplication(), new TaskListener() {
            @Override
            public void onTaskResponse(TaskResult result) {
                if (result.isSuccess) {
                    Intent txIntent = new Intent(WithDrawPoolActivity.this, TxDetailgRPCActivity.class);
        ...
        }, mAccount, mBaseChain, mAccount.address, mKavaShareAmount.toPlainString(), mKavaPoolTokenA, mKavaPoolTokenB, mTxMemo, mTxFee, getBaseDao().getChainIdGrpc()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
    ...
    private class WithDrawPoolPageAdapter extends FragmentPagerAdapter {
        ...
        public WithDrawPoolPageAdapter(FragmentManager fm) {
            super(fm);
            mFragments.clear();
            mFragments.add(WithdrawPoolStep0Fragment.newInstance());
            mFragments.add(StepMemoFragment.newInstance());
            mFragments.add(StepFeeSetFragment.newInstance());
            mFragments.add(WithdrawPoolStep3Fragment.newInstance());
        }
