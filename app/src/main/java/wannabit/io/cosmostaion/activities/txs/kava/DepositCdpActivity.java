...
public class DepositCdpActivity extends BaseBroadCastActivity {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(DepositCdpActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_deposit_cdp_step_2));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(DepositCdpActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_deposit_cdp_step_3));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(DepositCdpActivity.this, R.drawable.step_4_img_4));
    ...
    public void onStartDepositCdp() {
        if (getBaseDao().isAutoPass()) {
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaDepositCdpReq(getAuthResponse(mBaseChain, mAccount), mAccount.address, mAccount.address, mCollateral, mCollateralType,
