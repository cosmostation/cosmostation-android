...
public class BorrowCdpActivity extends BaseBroadCastActivity implements TaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTitle.setText(R.string.str_draw_debt_cdp_c);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mTvStep.setText(R.string.str_draw_debt_cdp_step_2);
                } else if (i == 2) {
                    mIvStep.setImageResource(R.drawable.step_4_img_3);
                    mTvStep.setText(R.string.str_draw_debt_cdp_step_3);
                    ((IRefreshTabListener) mPageAdapter.mCurrentFragment).onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageResource(R.drawable.step_4_img_4);
                    mTvStep.setText(R.string.str_draw_debt_cdp_step_4);
                    ((IRefreshTabListener) mPageAdapter.mCurrentFragment).onRefreshTab();
                }
            }
