...
public class WithdrawHardActivity extends BaseBroadCastActivity {
    ...
    private void onBroadCastTx() {
        new KavaWithdrawHardGrpcTask(getBaseApplication(), new TaskListener() {
            @Override
            public void onTaskResponse(TaskResult result) {
                if (result.isSuccess) {
                    Intent txIntent = new Intent(WithdrawHardActivity.this, TxDetailgRPCActivity.class);
    ...
    private class WithdrawHarvestPageAdapter extends FragmentPagerAdapter {
        ...
        public WithdrawHarvestPageAdapter(FragmentManager fm) {
            super(fm);
            mFragments.clear();
            mFragments.add(WithdrawHardStep0Fragment.newInstance());
            mFragments.add(StepMemoFragment.newInstance());
            mFragments.add(StepFeeSetFragment.newInstance());
            mFragments.add(WithdrawHardStep3Fragment.newInstance());
        }
