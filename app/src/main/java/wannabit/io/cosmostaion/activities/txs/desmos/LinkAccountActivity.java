...
import wannabit.io.cosmostaion.fragment.txs.desmos.LinkAccountStep0Fragment;
import wannabit.io.cosmostaion.fragment.txs.desmos.LinkAccountStep3Fragment;
...
public class LinkAccountActivity extends BaseBroadCastActivity implements TaskListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIvStep.setImageDrawable(ContextCompat.getDrawable(LinkAccountActivity.this, R.drawable.step_4_img_1));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if (i == 0) {
                    ...
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(LinkAccountActivity.this, R.drawable.step_4_img_2));
                    mTvStep.setText(getString(R.string.str_link_account_step_1));
                } else if (i == 2) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(LinkAccountActivity.this, R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_link_account_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3) {
                    mIvStep.setImageDrawable(ContextCompat.getDrawable(LinkAccountActivity.this, R.drawable.step_4_img_4));
