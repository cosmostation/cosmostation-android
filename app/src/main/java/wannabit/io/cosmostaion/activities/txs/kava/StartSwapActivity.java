...
public class StartSwapActivity extends BaseBroadCastActivity {
    ...
    public void onStartSwap() {
        if (getBaseDao().isAutoPass()) {
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcKavaSwapReq(getAuthResponse(mBaseChain, mAccount), mAccount.address, mKavaSwapIn, mKavaSwapOut,
