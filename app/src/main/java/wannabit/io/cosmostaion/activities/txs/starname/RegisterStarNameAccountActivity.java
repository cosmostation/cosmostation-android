...
import wannabit.io.cosmostaion.fragment.txs.starname.RegisterAccount1Fragment;
import wannabit.io.cosmostaion.fragment.txs.starname.RegisterAccount4Fragment;
...
public class RegisterStarNameAccountActivity extends BaseBroadCastActivity {
    ...
    private void onBroadCastTx() {
        new RegisterAccountGrpcTask(getBaseApplication(), new TaskListener() {
            @Override
            public void onTaskResponse(TaskResult result) {
                if (result.isSuccess) {
                    Intent txIntent = new Intent(RegisterStarNameAccountActivity.this, TxDetailgRPCActivity.class);
        ...
        }, mAccount, mBaseChain, mStarNameDomain, mStarNameAccount, mStarNameResources, mTxMemo, mTxFee, getBaseDao().getChainIdGrpc()).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
    }
