...
public class AuthzSendStep0Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.equals(mNextBtn)) {
            ...
            authzSendQrCodeLauncher.launch(integrator.createScanIntent());
    ...
    private ActivityResultLauncher<Intent> authzSendQrCodeLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
