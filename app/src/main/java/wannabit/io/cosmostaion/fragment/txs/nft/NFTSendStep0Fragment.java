...
public class NFTSendStep0Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.equals(mNextBtn)) {
            ...
            nftSendQrCodeLauncher.launch(integrator.createScanIntent());
    ...
    private ActivityResultLauncher<Intent> nftSendQrCodeLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
