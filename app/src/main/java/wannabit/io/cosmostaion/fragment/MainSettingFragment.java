...
public class MainSettingFragment extends BaseFragment implements View.OnClickListener {
            ...
            CommonAlertDialog.showDoubleButton(getMainActivity(), getString(R.string.str_starname_walletconnect_alert_title), getString(R.string.str_starname_walletconnect_alert_msg),
                    ...
                    getString(R.string.str_continue), view -> new TedPermission(getMainActivity()).setPermissionListener(new PermissionListener() {
                                ...
                                public void onPermissionGranted() {
                                    ...
                                    mainSettingFragmentQrcodeLauncher.launch(integrator.createScanIntent());
                                }
    ...
    private void onClickAppLock() {
        ...
        if (getBaseDao().getUsingAppLock()) {
            ...
            mainSettingFragmentResultLauncher.launch(intent);
    ...
    private final ActivityResultLauncher<Intent> mainSettingFragmentResultLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
    ...
    private final ActivityResultLauncher<Intent> mainSettingFragmentQrcodeLauncher = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
