...
import wannabit.io.cosmostaion.dialog.DialogFragment_Currency_Set;
...
public class MainSettingFragment extends BaseFragment implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.equals(mBtnAddWallet)) {
            ...
            DialogFragment_Currency_Set currency_dialog = DialogFragment_Currency_Set.newInstance(null);
