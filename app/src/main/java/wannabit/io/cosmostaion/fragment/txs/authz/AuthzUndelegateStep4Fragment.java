...
public class AuthzUndelegateStep4Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static AuthzUndelegateStep4Fragment newInstance() {
        return new AuthzUndelegateStep4Fragment();
    }
    ...
    public void onClick(View v) {
        if (v.equals(mBeforeBtn)) {
            ...
            getSActivity().onAuthzUndelegate();
        }
    }
