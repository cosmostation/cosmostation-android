...
public class ReplaceStarName0Fragment extends BaseFragment implements View.OnClickListener {
    ...
    private final ActivityResultLauncher<Intent> addAddressReplaceStarName = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), result -> {
