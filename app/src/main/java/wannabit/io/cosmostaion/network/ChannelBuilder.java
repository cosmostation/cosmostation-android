...
public class ChannelBuilder {
    ...
    public static ManagedChannel getChain(BaseChain chain) {
        if (chain != null) {
            ...
            return chainConfig.getConnection();
        }
        return null;
    }

    private static ManagedChannel channel_cosmos_main = null;
    public static ManagedChannel getCosmosMain(BaseChain baseChain) {
    ...
    public static ManagedChannel getIrisMain(BaseChain baseChain) {
        ChainConfig chainConfig = ChainFactory.getChain(baseChain);
    ...
    public static ManagedChannel getJunoMain(BaseChain baseChain) {
        ChainConfig chainConfig = ChainFactory.getChain(baseChain);
