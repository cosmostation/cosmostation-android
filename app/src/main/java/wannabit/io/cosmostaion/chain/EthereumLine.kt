...
class EthereumLine(chainName: String, imageUrl: String, bip44: String) {
...
//            AppDatabase.getInstance().balanceDao().insert(Balance(wallet.id, "", config.displayDenom, response.balance.toString(), Date().time))
//        }
//    }
//
