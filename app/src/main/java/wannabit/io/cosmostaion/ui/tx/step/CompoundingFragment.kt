...
class CompoundingFragment(
    val selectedChain: CosmosLine,
    private val claimableRewards: MutableList<DistributionProto.DelegationDelegatorReward?>
) : BaseTxFragment() {
    ...
    private fun initView() {
        binding.apply {
            compoundingView.setBackgroundResource(R.drawable.cell_bg)
    ...
    private val getCompoundingResultLauncher: ActivityResultLauncher<Intent> =
        registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { result ->
            if (result.resultCode == Activity.RESULT_OK && isAdded) {
                ...
                txViewModel.broadCompounding(getChannel(selectedChain), selectedChain.address, claimableRewards, selectedChain.stakeDenom, txFee, txMemo, selectedChain)
            }
        }
    ...
    private fun txSimul() {
        binding.apply {
            ...
            txViewModel.simulateCompounding(getChannel(selectedChain), selectedChain.address, claimableRewards, selectedChain.stakeDenom, txFee, txMemo)
        }
    }
