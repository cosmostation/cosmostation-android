            ...
            BaseData.assets?.firstOrNull { it.denom == lendMarket?.denom }?.let { asset ->
                asset.decimals?.let { decimal ->
                    ...
                    lendMarket?.let { market ->
                        ...
                        mySuppliedAmount.text = formatString(myDepositAmount.movePointLeft(decimal).setScale(decimal, RoundingMode.DOWN).toPlainString(), decimal)
                        ...
                        myBorrowedAmount.text = formatString(myBorrowAmount.movePointLeft(decimal).setScale(decimal, RoundingMode.DOWN).toPlainString(), decimal)
