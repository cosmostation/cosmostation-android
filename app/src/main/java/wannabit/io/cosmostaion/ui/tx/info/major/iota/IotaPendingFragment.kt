...
class IotaPendingFragment : Fragment() {
    ...
    companion object {
        @JvmStatic
        fun newInstance(selectedChain: BaseChain): IotaPendingFragment {
            val args = Bundle().apply {
                putParcelable("selectedChain", selectedChain)
            }
            val fragment = IotaPendingFragment()
            ...
            lifecycleScope.launch(Dispatchers.IO) {
                ...
                withContext(Dispatchers.Main) {
                    ...
                    if (pending.isEmpty()) {
                        ...
                        iotaStakingInfoAdapter.submitList(pending)
                        if (::iotaStakingInfoAdapter.isInitialized) {
                            iotaStakingInfoAdapter.setOnItemClickListener { _ ->
