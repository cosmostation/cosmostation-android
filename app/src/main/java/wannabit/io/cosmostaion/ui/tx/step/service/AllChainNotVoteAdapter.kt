...
interface CheckListener {
    fun proposalNotVoteCheck(voteModel: VoteAllModel, proposal: CosmosProposal, tag: Int)
    fun proposalAllVoteCheck(voteModel: VoteAllModel, proposal: CosmosProposal, tag: Int)
}

class AllChainNotVoteAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return when (viewType) {
            ...
            VIEW_TYPE_VOTING_ITEM -> {
                ...
                AllChainNotVoteViewHolder(parent.context, binding)
            }
