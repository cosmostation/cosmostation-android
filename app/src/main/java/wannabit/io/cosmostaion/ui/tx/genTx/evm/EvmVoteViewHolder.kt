...
import wannabit.io.cosmostaion.ui.tx.genTx.evm.EvmVoteAdapter.ClickListener

class EvmVoteViewHolder(
    val context: Context,
    private val binding: ItemVoteBinding
) : RecyclerView.ViewHolder(binding.root) {

    fun bind(proposal: CosmosProposal, listener: ClickListener) {
        binding.apply {
