    ...
    fun bind(
        ...
        binding.apply {
            ...
            yesView.setOnClickListener {
                updateView(this, proposal)
                listener.proposalNotVoteCheck(voteAllModel, proposal, 1)
            }

            abstainView.setOnClickListener {
                updateView(this, proposal)
                listener.proposalNotVoteCheck(voteAllModel, proposal, 2)
            }

            noView.setOnClickListener {
                updateView(this, proposal)
                listener.proposalNotVoteCheck(voteAllModel, proposal, 3)
            }

            vetoView.setOnClickListener {
                updateView(this, proposal)
                listener.proposalNotVoteCheck(voteAllModel, proposal, 4)
            }
