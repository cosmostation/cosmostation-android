...
public class V3Asset implements Parcelable {
    ...
    public static final Creator<V3Asset> CREATOR = new Creator<V3Asset>() {
        @Override
        public V3Asset createFromParcel(Parcel in) {
            return new V3Asset(in);
        }

        @Override
        public V3Asset[] newArray(int size) {
            return new V3Asset[size];
        }
    };
