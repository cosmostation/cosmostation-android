...
public final class MsgGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgAnchorData,
      regen.data.v1alpha2.Tx.MsgAnchorDataResponse> getAnchorDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AnchorData",
      requestType = regen.data.v1alpha2.Tx.MsgAnchorData.class,
      responseType = regen.data.v1alpha2.Tx.MsgAnchorDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgAnchorData,
      regen.data.v1alpha2.Tx.MsgAnchorDataResponse> getAnchorDataMethod() {
    io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgAnchorData, regen.data.v1alpha2.Tx.MsgAnchorDataResponse> getAnchorDataMethod;
    if ((getAnchorDataMethod = MsgGrpc.getAnchorDataMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getAnchorDataMethod = MsgGrpc.getAnchorDataMethod) == null) {
          MsgGrpc.getAnchorDataMethod = getAnchorDataMethod =
              io.grpc.MethodDescriptor.<regen.data.v1alpha2.Tx.MsgAnchorData, regen.data.v1alpha2.Tx.MsgAnchorDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AnchorData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  regen.data.v1alpha2.Tx.MsgAnchorData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  regen.data.v1alpha2.Tx.MsgAnchorDataResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgSignData,
      regen.data.v1alpha2.Tx.MsgSignDataResponse> getSignDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SignData",
      requestType = regen.data.v1alpha2.Tx.MsgSignData.class,
      responseType = regen.data.v1alpha2.Tx.MsgSignDataResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgSignData,
      regen.data.v1alpha2.Tx.MsgSignDataResponse> getSignDataMethod() {
    io.grpc.MethodDescriptor<regen.data.v1alpha2.Tx.MsgSignData, regen.data.v1alpha2.Tx.MsgSignDataResponse> getSignDataMethod;
    if ((getSignDataMethod = MsgGrpc.getSignDataMethod) == null) {
      synchronized (MsgGrpc.class) {
        if ((getSignDataMethod = MsgGrpc.getSignDataMethod) == null) {
          MsgGrpc.getSignDataMethod = getSignDataMethod =
              io.grpc.MethodDescriptor.<regen.data.v1alpha2.Tx.MsgSignData, regen.data.v1alpha2.Tx.MsgSignDataResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SignData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  regen.data.v1alpha2.Tx.MsgSignData.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  regen.data.v1alpha2.Tx.MsgSignDataResponse.getDefaultInstance()))
  ...
  public static abstract class MsgImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void anchorData(regen.data.v1alpha2.Tx.MsgAnchorData request,
        io.grpc.stub.StreamObserver<regen.data.v1alpha2.Tx.MsgAnchorDataResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getAnchorDataMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    public void signData(regen.data.v1alpha2.Tx.MsgSignData request,
        io.grpc.stub.StreamObserver<regen.data.v1alpha2.Tx.MsgSignDataResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSignDataMethod(), responseObserver);
    }
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                regen.data.v1alpha2.Tx.MsgAnchorData,
                regen.data.v1alpha2.Tx.MsgAnchorDataResponse>(
                  this, METHODID_ANCHOR_DATA)))
          .addMethod(
            getSignDataMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                regen.data.v1alpha2.Tx.MsgSignData,
                regen.data.v1alpha2.Tx.MsgSignDataResponse>(
  ...
  public static final class MsgBlockingStub extends io.grpc.stub.AbstractBlockingStub<MsgBlockingStub> {
     ...
     * </pre>
     */
    public regen.data.v1alpha2.Tx.MsgAnchorDataResponse anchorData(regen.data.v1alpha2.Tx.MsgAnchorData request) {
     ...
     * </pre>
     */
    public regen.data.v1alpha2.Tx.MsgSignDataResponse signData(regen.data.v1alpha2.Tx.MsgSignData request) {
      return blockingUnaryCall(
  ...
  public static final class MsgFutureStub extends io.grpc.stub.AbstractFutureStub<MsgFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<regen.data.v1alpha2.Tx.MsgAnchorDataResponse> anchorData(
        regen.data.v1alpha2.Tx.MsgAnchorData request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<regen.data.v1alpha2.Tx.MsgSignDataResponse> signData(
        regen.data.v1alpha2.Tx.MsgSignData request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_ANCHOR_DATA:
          serviceImpl.anchorData((regen.data.v1alpha2.Tx.MsgAnchorData) request,
              (io.grpc.stub.StreamObserver<regen.data.v1alpha2.Tx.MsgAnchorDataResponse>) responseObserver);
          break;
        case METHODID_SIGN_DATA:
          serviceImpl.signData((regen.data.v1alpha2.Tx.MsgSignData) request,
              (io.grpc.stub.StreamObserver<regen.data.v1alpha2.Tx.MsgSignDataResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class MsgBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return regen.data.v1alpha2.Tx.getDescriptor();
    }
