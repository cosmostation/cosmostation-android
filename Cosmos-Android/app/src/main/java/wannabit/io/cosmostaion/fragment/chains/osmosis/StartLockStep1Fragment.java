...
public class StartLockStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    public static StartLockStep1Fragment newInstance(Bundle bundle) {
        StartLockStep1Fragment fragment = new StartLockStep1Fragment();
