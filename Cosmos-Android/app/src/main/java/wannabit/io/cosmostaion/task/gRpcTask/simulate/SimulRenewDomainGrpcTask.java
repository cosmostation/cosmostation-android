...
public class SimulRenewDomainGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcRenewDomainSimulateReq(mAuthResponse, mDomain, mAccount.address, mFees, mMemo, deterministicKey, mChainId);
