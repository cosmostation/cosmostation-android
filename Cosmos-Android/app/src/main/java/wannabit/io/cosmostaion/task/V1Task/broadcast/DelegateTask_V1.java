...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_V1_BROAD_DELEGATE;

public class DelegateTask_V1 extends CommonTask {
    ...
    public DelegateTask_V1(BaseApplication app, TaskListener listener,
        ...
        this.mFees = toFees;
        this.mResult.taskType   = TASK_V1_BROAD_DELEGATE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        if (auth != null) {
            ...
            ReqBroadCast reqBroadCast = Signer.genSignedDelegateTxV1(mAccount.address, auth.account_number, auth.sequence, mValidatorAddress, mAmount, mFees, mMemo, deterministicKey, getChain(mAccount.baseChain));
