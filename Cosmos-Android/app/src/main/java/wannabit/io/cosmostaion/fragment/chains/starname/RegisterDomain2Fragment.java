...
import static wannabit.io.cosmostaion.base.BaseConstant.IOV_GAS_AMOUNT_REGISTER;
...
public class RegisterDomain2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(IOV_MAIN) || getSActivity().mBaseChain.equals(IOV_TEST)) {
            ...
            mFeeAmount = new BigDecimal(IOV_GAS_AMOUNT_REGISTER).multiply(new BigDecimal(IOV_GAS_RATE_AVERAGE)).setScale(0);
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(IOV_MAIN)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = IOV_GAS_AMOUNT_REGISTER;
