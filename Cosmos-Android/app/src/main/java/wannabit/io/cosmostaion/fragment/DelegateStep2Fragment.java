...
import static wannabit.io.cosmostaion.base.BaseConstant.SIF_GAS_AMOUNT_STAKE;
...
public class DelegateStep2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(KAVA_MAIN) || getSActivity().mBaseChain.equals(KAVA_TEST)) {
            ...
            mGasAmount.setText(SENTINEL_GAS_AMOUNT_STAKE);
            mGasRate.setText(WDp.getDpString(SENTINEL_GAS_FEE_RATE_AVERAGE, 1));
            mFeeAmount = new BigDecimal(SENTINEL_GAS_AMOUNT_STAKE).multiply(new BigDecimal(SENTINEL_GAS_FEE_RATE_AVERAGE)).setScale(0);
            if(getBaseDao().getCurrency() != 5) {
            ...
            mGasAmount.setText(FETCH_GAS_AMOUNT_STAKE);
            ...
            mGasAmount.setText(SIF_GAS_AMOUNT_STAKE);
    ...
    public void onClick(View v) {
        if(v.equals(mBeforeBtn)) {
            ...
            if (getSActivity().mBaseChain.equals(KAVA_MAIN) || getSActivity().mBaseChain.equals(KAVA_TEST)) {
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = SENTINEL_GAS_AMOUNT_STAKE;
                getSActivity().mTxFee = fee;
                ...
                amount.add(gasCoin);
                fee.amount = amount;
                fee.gas = FETCH_GAS_AMOUNT_STAKE;
                getSActivity().mTxFee = fee;
