...
public class ResKavaMyCdps {
    ...
    public class MyCDP {
        ...
        public BigDecimal getEstimatedTotalFee(Context c, ResKavaCdpParam.KavaCollateralParam cParam) {
            BigDecimal hiddenFeeValue = WDp.getCdpHiddenFee(c, getRawDebtAmount(), cParam, cdp);
            return  getAccumulatedFees().add(hiddenFeeValue);
        }

        public BigDecimal getEstimatedTotalDebt(Context c, ResKavaCdpParam.KavaCollateralParam cParam) {
            BigDecimal hiddenFeeValue = WDp.getCdpHiddenFee(c, getRawDebtAmount(), cParam, cdp);
            return  getRawDebtAmount().add(hiddenFeeValue);
        }

        public BigDecimal getLiquidationPrice(Context c, ResKavaCdpParam.KavaCollateralParam cParam) {
        ...
        public BigDecimal getWithdrawableAmount(Context c, ResKavaCdpParam.KavaCollateralParam cParam, BigDecimal price, BigDecimal selfDeposit) {
            int denomCDecimal = WUtil.getKavaCoinDecimal(getDenom());
            int denomPDecimal = WUtil.getKavaCoinDecimal(getPDenom());
...
//            WLog.w("maxWithdrawableAmount " + maxWithdrawableAmount);
        ...
        public BigDecimal getMoreLoanableAmount(Context c, ResKavaCdpParam.KavaCollateralParam cParam) {
