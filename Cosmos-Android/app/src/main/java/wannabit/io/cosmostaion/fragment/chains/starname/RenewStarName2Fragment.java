...
import static wannabit.io.cosmostaion.base.BaseConstant.IOV_GAS_AMOUNT_RENEW;
...
public class RenewStarName2Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (getSActivity().mBaseChain.equals(IOV_MAIN) || getSActivity().mBaseChain.equals(IOV_TEST)) {
            ...
            mFeeAmount = new BigDecimal(IOV_GAS_AMOUNT_RENEW).multiply(new BigDecimal(IOV_GAS_RATE_AVERAGE)).setScale(0);
