    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        mCosmosPath.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((RestoreActivity)getActivity()).onUsingFetchNewBip(0);
                getDialog().dismiss();
            }
        });
        ...
        mETHNonLedgerPath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((RestoreActivity)getActivity()).onUsingFetchNewBip(1);
                getDialog().dismiss();
            }
        });
        ...
        mETHLedgerLivePAth.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((RestoreActivity)getActivity()).onUsingFetchNewBip(2);
                getDialog().dismiss();
            }
        });
        ...
        mETHLegacyPath.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((RestoreActivity)getActivity()).onUsingFetchNewBip(3);
                getDialog().dismiss();
            }
        });
