...
public class KavaCdpByDepositor extends CommonTask {

    private BaseChain mChain;
    private String mAddress;
    private String mDenom;

    public KavaCdpByDepositor(BaseApplication app, TaskListener listener, BaseChain chain, String address, String denom) {
        super(app, listener);
