...
public class OsmosisSwapInTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcSwapInReq(mAuthResponse, mSwapInRoute, mInputCoin.denom, mInputCoin.amount, mOutputcoin.amount, mFees, mMemo, deterministicKey, mChainId);
