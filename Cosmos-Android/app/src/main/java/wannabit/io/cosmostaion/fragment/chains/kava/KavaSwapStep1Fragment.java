...
public class KavaSwapStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    public static KavaSwapStep1Fragment newInstance(Bundle bundle) {
        KavaSwapStep1Fragment fragment = new KavaSwapStep1Fragment();
    ...
    private StartSwapActivity getSActivity() { return (StartSwapActivity)getBaseActivity(); }
