...
public class DeleteAccountGrpcTask extends CommonTask {
    ...
    public DeleteAccountGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String domain, String name, String memo, Fee fee, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_DELETE_ACCOUNT;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcDeleteAccountReq(mAuthResponse, mDomain, mName, mAccount.address, mFees, mMemo, deterministicKey, mChainId);
