...
public class SimulOsmosisSwaplGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcSwapInSimulateReq(mAuthResponse, mSwapInRoute, mInputCoin.denom, mInputCoin.amount, mOutputcoin.amount, mFees, mMemo, deterministicKey, mChainId);
