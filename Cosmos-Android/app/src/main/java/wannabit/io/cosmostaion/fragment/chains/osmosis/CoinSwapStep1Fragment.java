...
public class CoinSwapStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    private SwapActivity getSActivity() { return (SwapActivity)getBaseActivity(); }
