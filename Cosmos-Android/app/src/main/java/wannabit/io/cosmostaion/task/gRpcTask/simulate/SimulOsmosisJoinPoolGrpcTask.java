...
public class SimulOsmosisJoinPoolGrpcTask extends CommonTask {
    ...
    public SimulOsmosisJoinPoolGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, long poolId, Coin deposit0Coin, Coin deposit1Coin, String shareAmount, Fee fee, String memo, String chainId) {
        super(app, listener);
