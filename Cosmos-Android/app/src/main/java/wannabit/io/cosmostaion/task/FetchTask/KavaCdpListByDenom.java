...
public class KavaCdpListByDenom extends CommonTask {

    private BaseChain mChain;
    private String mDenom;

    public KavaCdpListByDenom(BaseApplication app, TaskListener listener, BaseChain chain, String denom) {
        super(app, listener);
        ...
        try {
            if (mChain.equals(BaseChain.KAVA_MAIN)) {
                ...
                if(response.isSuccessful() && response.body() != null && response.body().result != null) {
                    ...
                    WLog.w("KavaCdpListByDenom : NOk");
                }
            }

        } catch (Exception e) {
            WLog.w("KavaCdpListByDenom Error " + e.getMessage());
        }
        return mResult;
    }
}