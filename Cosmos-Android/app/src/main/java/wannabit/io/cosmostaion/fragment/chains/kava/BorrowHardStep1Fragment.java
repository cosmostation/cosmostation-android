...
public class BorrowHardStep1Fragment extends BaseFragment implements View.OnClickListener {
    ...
    public static BorrowHardStep1Fragment newInstance(Bundle bundle) {
        BorrowHardStep1Fragment fragment = new BorrowHardStep1Fragment();
