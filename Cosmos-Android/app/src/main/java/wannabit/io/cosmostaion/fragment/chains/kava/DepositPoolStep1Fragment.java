...
public class DepositPoolStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    public static DepositPoolStep1Fragment newInstance(Bundle bundle) {
        DepositPoolStep1Fragment fragment = new DepositPoolStep1Fragment();
