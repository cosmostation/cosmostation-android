...
public class SingleAllRedelegateState extends CommonTask {
    ...
    public SingleAllRedelegateState(BaseApplication app, TaskListener listener, Account account) {
        super(app, listener);
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            Response<ArrayList<ResLcdRedelegate>> response = ApiClient.getWannabitChain(mApp, BaseChain.getChain(mAccount.baseChain)).getRedelegateAllHistory(mAccount.address).execute();
