...
public class OsmosisExitPooGrpcTask extends CommonTask {
    ...
    public OsmosisExitPooGrpcTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, long poolId, Coin deposit0Coin, Coin deposit1Coin, String shareAmount, Fee fee, String memo, String chainId) {
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_EXIT_POOL;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcExitPoolReq(mAuthResponse, mPoolId, mDeposit0Coin, mDeposit1Coin, mShareAmount, mFees, mMemo, deterministicKey, mChainId);
