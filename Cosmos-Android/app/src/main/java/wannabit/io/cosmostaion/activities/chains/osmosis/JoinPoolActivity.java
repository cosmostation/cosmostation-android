...
public class JoinPoolActivity extends BaseBroadCastActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTvStep.setText(getString(R.string.str_osmosis_join_pool_step_0));
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int i) {
                if(i == 0) {
                    ...
                    mTvStep.setText(getString(R.string.str_osmosis_join_pool_step_1));
                } else if (i == 2 ) {
                    mIvStep.setImageDrawable(getDrawable(R.drawable.step_4_img_3));
                    mTvStep.setText(getString(R.string.str_osmosis_join_pool_step_2));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                } else if (i == 3 ) {
                    mIvStep.setImageDrawable(getDrawable(R.drawable.step_4_img_4));
                    mTvStep.setText(getString(R.string.str_osmosis_join_pool_step_3));
                    mPageAdapter.mCurrentFragment.onRefreshTab();
                }
            }
    ...
    private class JoinPoolPageAdapter extends FragmentPagerAdapter {
        ...
        public JoinPoolPageAdapter(FragmentManager fm) {
            ...
            mFragments.add(JoinPoolStep1Fragment.newInstance(null));
