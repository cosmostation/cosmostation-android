...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_V1_BROAD_UNDELEGATE;

public class UndelegateTask_V1 extends CommonTask {
    ...
    public UndelegateTask_V1(BaseApplication app, TaskListener listener, Account account,
                             String toValidatorAddress, Coin toUnDelegateAmount, String toDelegateMemo,
                             Fee toFees) {
        super(app, listener);
        this.mAccount = account;
        this.mValidatorAddress = toValidatorAddress;
        this.mAmount = toUnDelegateAmount;
        this.mMemo = toDelegateMemo;
        this.mFees = toFees;
        this.mResult.taskType   = TASK_V1_BROAD_UNDELEGATE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        if (auth != null) {
            ...
            ReqBroadCast reqBroadCast = Signer.genSignedUnDelegateTxV1(mAccount.address, auth.account_number, auth.sequence, mValidatorAddress, mAmount, mFees, mMemo, deterministicKey, getChain(mAccount.baseChain));
            ...
            if (response.isSuccessful() && response.body() != null) {
                ...
                WLog.e("UndelegateTask_V1 Error");
            }
        }
        return mResult;
    }
