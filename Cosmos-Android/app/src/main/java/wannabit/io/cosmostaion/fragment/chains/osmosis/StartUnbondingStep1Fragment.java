...
public class StartUnbondingStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    public static StartUnbondingStep1Fragment newInstance(Bundle bundle) {
        StartUnbondingStep1Fragment fragment = new StartUnbondingStep1Fragment();
