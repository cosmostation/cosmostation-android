...
//            }
            ...
            if (mBaseChain.equals(CERTIK_MAIN) || mBaseChain.equals(SECRET_MAIN) || mBaseChain.equals(BAND_MAIN) ||
                    mBaseChain.equals(SIF_MAIN) || mBaseChain.equals(KI_MAIN) || mBaseChain.equals(CERTIK_TEST)) {
...
//                }
    ...
    private void onInitView() {
        ...
        if (mAccount.hasPrivateKey) {
            ...
            mAccountPath.setText(WDp.getPath(BaseChain.getChain(mAccount.baseChain), Integer.parseInt(mAccount.path), mAccount.newBip44, mAccount.fetchNewBip));
