...
//            }
            ...
            if (mBaseChain.equals(SECRET_MAIN) || mBaseChain.equals(BAND_MAIN) || mBaseChain.equals(KI_MAIN)) {
...
//                }
    ...
    private void onInitView() {
        ...
        if (mBaseChain.equals(COSMOS_MAIN)) {
            ...
            mCardName.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgFetch));
            mCardAlarm.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgFetch));
            mCardAlarm.setVisibility(View.GONE);
            ...
            mCardAlarm.setVisibility(View.GONE);
            mCardBody.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgCryto));
            ...
            mCardName.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgKi));
            mCardAlarm.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgKi));
            mCardAlarm.setVisibility(View.GONE);
            mCardBody.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgKi));
            mCardRewardAddress.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgKi));
            mCardRewardAddress.setVisibility(View.VISIBLE);
            mChainImg.setImageDrawable(getResources().getDrawable(R.drawable.chain_kifoundation));

        } else if (mBaseChain.equals(OSMOSIS_MAIN)) {
            mCardName.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgOsmosis));
            mCardAlarm.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgOsmosis));
            mCardAlarm.setVisibility(View.GONE);
            mCardBody.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgOsmosis));
            ...
            mCardName.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgEmoney));
            mCardAlarm.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgEmoney));
            mCardAlarm.setVisibility(View.GONE);
            mCardBody.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgEmoney));
            mCardRewardAddress.setCardBackgroundColor(getResources().getColor(R.color.colorTransBgEmoney));
            mCardRewardAddress.setVisibility(View.VISIBLE);
            mChainImg.setImageDrawable(getResources().getDrawable(R.drawable.chain_emoney));
            ...
            mCardRewardAddress.setCardBackgroundColor(getResources().getColor(R.color.colorTransBg));
            mCardRewardAddress.setVisibility(View.VISIBLE);
            mChainImg.setImageDrawable(getResources().getDrawable(R.drawable.testnet_althea));
            ...
            mCardRewardAddress.setCardBackgroundColor(getResources().getColor(R.color.colorTransBg));
            mCardRewardAddress.setVisibility(View.VISIBLE);
            mChainImg.setImageDrawable(getResources().getDrawable(R.drawable.testnet_umee));
            ...
            mCardRewardAddress.setCardBackgroundColor(getResources().getColor(R.color.colorTransBg));
            mCardRewardAddress.setVisibility(View.VISIBLE);
            mChainImg.setImageDrawable(getResources().getDrawable(R.drawable.testnet_axelar));
        }
