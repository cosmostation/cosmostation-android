...
public class SimulRegisterDomainGrpcTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.SimulateRequest simulateTxRequest = Signer.getGrpcRegisterDomainSimulateReq(mAuthResponse, mDomain, mAccount.address, mDomainType, mFees, mMemo, deterministicKey, mChainId);
