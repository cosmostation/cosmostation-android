...
public class OsmosisJoinPoolTask extends CommonTask {
    ...
    private String              mPoolId, mShareAmount, mMemo;
    ...
    public OsmosisJoinPoolTask(BaseApplication app, TaskListener listener, Account account, BaseChain basechain, String poolId, Coin deposit0Coin, Coin deposit1Coin, String shareAmount, Fee fee, String memo, String chainId) {
        super(app, listener);
        ...
        this.mResult.taskType = TASK_GRPC_GEN_TX_JOIN_POOL;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        try {
            ...
            ServiceOuterClass.BroadcastTxRequest broadcastTxRequest = Signer.getGrpcJoinPoolReq(mAuthResponse, mPoolId, mDeposit0Coin, mDeposit1Coin, mShareAmount, mFees, mMemo, deterministicKey, mChainId);
