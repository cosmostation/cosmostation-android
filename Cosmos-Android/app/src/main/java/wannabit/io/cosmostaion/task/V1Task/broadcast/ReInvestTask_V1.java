...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_V1_BROAD_REINVEST;

public class ReInvestTask_V1 extends CommonTask {
    ...
    public ReInvestTask_V1(BaseApplication app, TaskListener listener, Account mAccount,
                             String mToValidator, Coin mRedelegateAmount, String mReDelegateMemo,
                             Fee mFees) {
        super(app, listener);
        ...
        this.mFees = mFees;
        this.mResult.taskType = TASK_V1_BROAD_REINVEST;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        if (auth != null) {
            ...
            ReqBroadCast reqBroadCast = Signer.genSignedReInvestTxV1(mAccount.address, auth.account_number, auth.sequence, mToValidator, mAmount, mFees, mMemo, deterministicKey, getChain(mAccount.baseChain));
