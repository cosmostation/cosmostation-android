...
public class Dialog_Safe_Score_Confirm extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        before_liquidation_price_title.setText(WDp.DpBeforeLiquidationPriceTitle(getContext(), getArguments().getString("denom").toUpperCase()));
        ...
        after_liquidation_price_title.setText(WDp.DpAfterLiquidationPriceTitle(getContext(), getArguments().getString("denom").toUpperCase()));
