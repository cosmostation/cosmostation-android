...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_V1_BROAD_VOTE;

public class VoteTask_V1 extends CommonTask {
    ...
    public VoteTask_V1(BaseApplication app, TaskListener listener, Account account, String proposalId, String opinion, String memo, Fee fee) {
        super(app, listener);
        ...
        this.mMemo              = memo;
        this.mFees              = fee;
        this.mResult.taskType   = TASK_V1_BROAD_VOTE;
    }
    ...
    protected TaskResult doInBackground(String... strings) {
        ...
        if (auth != null) {
            ...
            ReqBroadCast reqBroadCast = Signer.genSignedVoteTxV1(mAccount.address, auth.account_number, auth.sequence, mProposalId, mOpinion, mFees, mMemo, deterministicKey, getChain(mAccount.baseChain));
