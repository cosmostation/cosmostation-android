...
import static wannabit.io.cosmostaion.base.BaseConstant.TASK_GEN_TX_DEPOSIT_CDP;
...
public class SimpleDepositCdpTask extends CommonTask {
    ...
    protected TaskResult doInBackground(String... strings) {
        try {
            ...
            Msg depositCdpMsg = MsgGenerator.genDepositCdpMsg(mOwner, mCollaterals, mDepositor, BaseChain.getChain(mAccount.baseChain));
