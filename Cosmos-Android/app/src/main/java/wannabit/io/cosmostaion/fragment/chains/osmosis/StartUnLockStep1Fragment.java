...
public class StartUnLockStep1Fragment extends BaseFragment implements View.OnClickListener{
    ...
    public static StartUnLockStep1Fragment newInstance(Bundle bundle) {
        StartUnLockStep1Fragment fragment = new StartUnLockStep1Fragment();
