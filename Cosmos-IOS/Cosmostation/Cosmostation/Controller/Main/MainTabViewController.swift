...
//        print("onFetchFinished ", self.mFetchCnt)
        ...
        if (mChainType == ChainType.BINANCE_MAIN || mChainType == ChainType.BINANCE_TEST) {
            ...
            return
                    ...
                    mChainType == ChainType.COSMOS_TEST || mChainType == ChainType.IRIS_TEST) {
...
//        print("BaseData.instance.mMyValidator ", BaseData.instance.mMyValidator.count)
    ...
    func onFetchAccountInfo(_ account: Account) {
        ...
        request.responseJSON { (response) in
            switch response.result {
            case .success(let res):
                if (self.mChainType == ChainType.BAND_MAIN || self.mChainType == ChainType.IOV_MAIN || self.mChainType == ChainType.SECRET_MAIN ||
