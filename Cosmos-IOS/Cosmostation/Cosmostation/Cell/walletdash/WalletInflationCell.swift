...
class WalletInflationCell: UITableViewCell {
    ...
    func updateView(_ account: Account?, _ chainType: ChainType?) {
        if (chainType == ChainType.COSMOS_MAIN || chainType == ChainType.AKASH_MAIN || chainType == ChainType.PERSIS_MAIN ||
                chainType == ChainType.CRYPTO_MAIN || chainType == ChainType.SENTINEL_MAIN ||
                chainType == ChainType.COSMOS_TEST || chainType == ChainType.RIZON_TEST || chainType == ChainType.ALTHEA_TEST) {
