...
class TokenDetailRizonCell: TokenDetailCell {
    ...
    override func onBindToken() {
        ...
        availableAmount.attributedText = WUtils.displayAmount2(BaseData.instance.getAvailable(RIZON_MAIN_DENOM), availableAmount.font!, 6, 6)
        ...
        rewardAmount.attributedText = WUtils.displayAmount2(BaseData.instance.getRewardSum(RIZON_MAIN_DENOM), rewardAmount.font, 6, 6)
        let vesting = BaseData.instance.getVestingAmount(RIZON_MAIN_DENOM)
        if (vesting.compare(NSDecimalNumber.zero).rawValue > 0) {
            vestingLayer.isHidden = false
            vestingAmount.attributedText = WUtils.displayAmount2(BaseData.instance.getVesting(RIZON_MAIN_DENOM), availableAmount.font!, 6, 6)
        }
    }
