...
@javax.annotation.Generated(
    ...
    comments = "Source: sifnode/ethbridge/v1/query.proto")
public final class QueryGrpc {

  private QueryGrpc() {}

  public static final String SERVICE_NAME = "sifnode.ethbridge.v1.Query";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest,
      sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse> getEthProphecyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "EthProphecy",
      requestType = sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest.class,
      responseType = sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest,
      sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse> getEthProphecyMethod() {
    io.grpc.MethodDescriptor<sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest, sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse> getEthProphecyMethod;
    if ((getEthProphecyMethod = QueryGrpc.getEthProphecyMethod) == null) {
      synchronized (QueryGrpc.class) {
        if ((getEthProphecyMethod = QueryGrpc.getEthProphecyMethod) == null) {
          QueryGrpc.getEthProphecyMethod = getEthProphecyMethod =
              io.grpc.MethodDescriptor.<sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest, sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "EthProphecy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse.getDefaultInstance()))
              .setSchemaDescriptor(new QueryMethodDescriptorSupplier("EthProphecy"))
              .build();
        }
      }
    }
  ...
  public static abstract class QueryImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void ethProphecy(sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest request,
  ...
  public static final class QueryFutureStub extends io.grpc.stub.AbstractFutureStub<QueryFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyResponse> ethProphecy(
        sifnode.ethbridge.v1.QueryOuterClass.QueryEthProphecyRequest request) {
  ...
  private static abstract class QueryBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return sifnode.ethbridge.v1.QueryOuterClass.getDescriptor();
    }
